"""build_clip_index — encode keyframe bằng CLIP (OpenAI) rồi lưu embeddings.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Encode keyframes with CLIP")
    ...
    parser.add_argument("--kind", default="clip", help="clip | clip-vit-b32 | ...")
    parser.add_argument("--model-name", default=None)
    parser.add_argument("--pretrained", default=None)
    parser.add_argument("--batch-size", type=int, default=32)
    parser.add_argument("--device", default="auto")
    parser.add_argument("--model-cache-dir", type=Path, default=Path("data/model_cache/clip"))
