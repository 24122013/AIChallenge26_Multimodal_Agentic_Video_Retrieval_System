export const MODES = ["KIST", "QA"];

export const MODE_ICONS: Record<string, React.ReactNode> = {
    "KIST": <span className="text-sm">🅺</span>,
    "QA": <span className="text-sm">🆀</span>, // Using 🆀 as the QA letter
};

export const KIST_MODES = ["visual", "hybrid", "caption", "ocr", "asr", "object", "temporal"];
export type KistMode = typeof KIST_MODES[number];

export const RETRIEVAL_METHODS = KIST_MODES.concat("qa");
...
export const METHOD_COLORS: Record<RetrievalMethod, string> = {
    ...
    objects: 'bg-orange-100 text-orange-700 dark:bg-orange-950/40 dark:text-orange-400',
